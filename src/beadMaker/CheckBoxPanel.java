...
public class CheckBoxPanel extends JPanel {
  ...
  public void init(
      String myLabel,
      boolean checkedState,
      final Palette pallette,
      final ImageController myImageController) {
    ...
    if (myLabelNoXML.equals("Perler")
        || myLabelNoXML.equals("Artkal-S")
        || myLabelNoXML.equals("Hama")) {

      ActionListener beadBrandActionListener =
          new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
              BMCheckBox checkBox = (BMCheckBox) actionEvent.getSource();
              checkBox.setSelected(
                  pallette.setBeadBrand(
                      StringHelper.removeXML(checkBox.getText()), checkBox.isSelected()));
    ...
    if (myLabelNoXML.equals("Show Grid")) {
      ...
      ActionListener showGridActionListener =
          new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
              BMCheckBox checkBox = (BMCheckBox) actionEvent.getSource();
    ...
    if (myLabelNoXML.equals("Show Pixels as Beads")) {
      ...
      ActionListener renderPixelsAsBeadsActionListener =
          new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
              BMCheckBox checkBox = (BMCheckBox) actionEvent.getSource();
    ...
    if (myLabelNoXML.equals("Exclude Pearls")) {
      ...
      ActionListener excludePearlsActionListener =
          new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
    ...
    if (myLabelNoXML.equals("Exclude Translucents")) {
      ...
      ActionListener excludeTranslucentsActionListener =
          new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
              pallette.selectedColorIndex = -1;
              imageController.selectedColorIndex = -1;
    ...
    if (myLabelNoXML.equals("Flip Image")) {
      ...
      ActionListener flipImageActionListener =
          new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
              BMCheckBox checkBox = (BMCheckBox) actionEvent.getSource();
              consoleHelper.PrintMessage(
                  " %%%%%%%%%%%%%%%%%%%%%%%%Flip Image click event detected");
