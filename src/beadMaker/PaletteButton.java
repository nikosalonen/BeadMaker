...
public class PaletteButton extends JButton {
  ...
  public PaletteButton(String label, Color myBGColor, int myColorIndex, Palette myPallette) {
    super(label);
  ...
  public void init() {
    ...
    ActionListener palletteColorClickActionListener =
        new ActionListener() {
          public void actionPerformed(ActionEvent actionEvent) {
            ...
            for (int i = 0; i < pallette.palletteSubPanels.size(); i++) {
              pallette
                  ...
                  .get(i)
                  .paletteButton
                  .setFont(new Font(labelFont.getName(), Font.PLAIN, labelFont.getSize()));
              pallette
                  .palletteSubPanels
                  .get(i)
                  .paletteButton
                  .setForeground(
                      ColorHelper.GetTextColorForBGColor(
                          pallette.palletteSubPanels.get(i).paletteButton.bgColor, true));
            }
