...
public class ColorChangerButtonPanel extends JPanel {
  ...
  public void init(String label, final ImageController imageController) {
    ...
    ActionListener bgColorChangeActionListener =
        new ActionListener() {
  ...
  public void init(
      String label, final ImageController imageController, final RenderLabel renderLabel) {
    this.setLayout(new FlowLayout(FlowLayout.LEFT));
    setOpaque(false);
    setPreferredSize(new Dimension(100, 40));
    setMaximumSize(new Dimension(360, 40));
    ...
    ActionListener gridColorChangeActionListener =
        new ActionListener() {
          public void actionPerformed(ActionEvent actionEvent) {
