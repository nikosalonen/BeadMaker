  ...
  public void mouseWheelMoved(MouseWheelEvent e) {
    ...
    if (e.isControlDown()) {
      ...
      if (e.getWheelRotation() == -1) { // wheel up
        beadMaker.controlPanel.sliderZoom.setValue(
            beadMaker.controlPanel.sliderZoom.getValue() + 50);
      } else { // wheel down
        beadMaker.controlPanel.sliderZoom.setValue(
            beadMaker.controlPanel.sliderZoom.getValue() - 50);
      }

      beadMaker.controlPanel.sliderZoom.jTextField.setText(
          Integer.toString(beadMaker.controlPanel.sliderZoom.getValue()));
      beadMaker.imageController.setColorMatchingWeight(
          "Zoom %", beadMaker.controlPanel.sliderZoom.getValue());
