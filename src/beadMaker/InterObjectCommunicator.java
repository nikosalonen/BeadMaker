...
public class InterObjectCommunicator {
  ...
  public void setInterObjectCommunicatorEventListener(
      InterObjectCommunicatorEventListener myOCommListener) {
    this.oCommListener[Subscriber.valueOf(myOCommListener.getObjectName()).ordinal()] =
        myOCommListener;
  }

  public void communicate(Object o, String subscriberName) {
    if (oCommListener != null)
      oCommListener[Subscriber.valueOf(subscriberName).ordinal()]
          .onInterObjectCommunicator_CommunicateEvent(o);
  }

  public void communicate(String descriptor, Object o, String subscriberName) {
    if (oCommListener != null)
      oCommListener[Subscriber.valueOf(subscriberName).ordinal()]
          .onInterObjectCommunicator_CommunicateEvent(descriptor, o);
  }

  public Object request(Object o, String subscriberName) {
    if (oCommListener != null) {
      return oCommListener[Subscriber.valueOf(subscriberName).ordinal()]
          .onInterObjectCommunicator_RequestEvent(o);
    } else {
      return null;
    }
  }
  ...
  public Object request(String descriptor, Object o, String subscriberName) {
    if (oCommListener != null) {
      return oCommListener[Subscriber.valueOf(subscriberName).ordinal()]
          .onInterObjectCommunicator_RequestEvent(descriptor, o);
    } else {
      return null;
    }
  }
